...
The <b xmlns:loc="http://microsoft.com/wdcml/l10n">IStream</b> interface inherits from the <a href="https://docs.microsoft.com/en-us/windows/win32/api/objidl/nn-objidl-isequentialstream">ISequentialStream</a> interface. <b>IStream</b> also has these types of members:
<ul>
